...
V["английский"]    = "thuộc về nước Anh, kiểu Anh"
V["немецкий"]      = "thuộc về nước Đức, kiểu Đức"
V["французский"]   = "thuộc về nước Pháp, kiểu Pháp"
V["русский"]       = "thuộc dân tộc Nga, kiểu Nga"
...
V["спортивный"]    = "thuộc về thể thao, có dáng vận động viên"
V["спряжение"]     = "sự chia động từ; lối chia"
V["близко"]        = "gần, ở gần (khoảng cách)"
V["за"]            = "đằng sau; vì, để đổi lấy (giới từ, đi với cách 4 hoặc cách 5)"
V["отлично"]       = "xuất sắc, tuyệt vời (cũng là điểm 5 của Nga)"
V["правильно"]     = "đúng, làm đúng theo quy tắc"
V["про"]           = "về, về chuyện… (giới từ KHẨU NGỮ, đi với cách 4)"
V["себя"]          = "bản thân mình (phản thân, không có dạng chủ ngữ)"
V["только"]        = "chỉ, chỉ có mỗi"
V["час"]           = "giờ (đơn vị 60 phút)"
V["часто"]         = "thường xuyên, hay xảy ra"
