...
V["касса"] = "quầy thu ngân, chỗ trả tiền (siêu thị, rạp, nhà ga)"
...
V["недорогой"] = "không đắt, giá phải chăng (phủ định của “đắt”, không phải từ nghĩa “rẻ tiền”)"
...
V["овощ"] = "rau củ (nhóm thực phẩm, đối lại với hoa quả)"
...
V["пачка"] = "gói, xấp (gói thuốc lá, gói bơ, xấp giấy)"
...
V["размер"] = "cỡ (quần áo, giày), kích thước"
...
V["свежий"] = "tươi, còn mới chưa cũ (đồ ăn, không khí, báo chí)"
...
V["сдача"] = "tiền thừa trả lại (sau khi trả tiền hàng)"
...
V["фрукт"] = "trái cây, hoa quả (nhóm thực phẩm, đối lại với rau củ)"
...
V["штука"] = "cái, chiếc (đơn vị đếm vật rời); món đồ, cái thứ (khi quên tên)"
