...
S["справа"] = (
    ...
    '<div class="hd-warn">⚠️ Bảng chia bên dưới KHÔNG phải của từ này: '
    '<b>спра́ва</b> ở đây là trạng từ, không biến cách. Từ điển đã dán nhầm bảng của một '
    'danh từ hiếm trùng mặt chữ — bỏ qua bảng.</div>'
