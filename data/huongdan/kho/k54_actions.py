...
V["танцевать"]  = "nhảy múa, khiêu vũ (chưa hoàn thành)"
V["ужинать"]    = "ăn tối (chưa hoàn thành)"
V["учиться"]    = "học, đi học (chưa hoàn thành — phản thân, KHÔNG phải \"dạy\")"
V["целовать"]   = "hôn (chưa hoàn thành)"
