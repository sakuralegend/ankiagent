...
V["повторять"] = "lặp lại, ôn lại (đang lặp, lặp nhiều lần)"
V["понимать"] = "hiểu (đang hiểu, thường hiểu)"
V["проверять"] = "kiểm tra, rà soát (đang kiểm, thường kiểm)"
V["рисовать"] = "vẽ, phác hoạ (bằng bút, cọ)"
V["сказать"] = "nói ra, bảo một câu (một lần rồi xong)"
V["спросить"] = "hỏi một câu để biết (không phải xin xỏ, nhờ vả)"
V["спрягаться"] = "được chia theo ngôi (nói về động từ)"
V["танцевать"] = "nhảy, khiêu vũ (theo bài bản)"
V["учиться"] = "học, theo học (ở trường nào, môn gì)"
