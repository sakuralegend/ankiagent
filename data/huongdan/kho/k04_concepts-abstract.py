...
V["правда"] = "sự thật (điều đúng với thực tế)"
...
V["обида"] = "nỗi tủi thân, sự phật lòng vì bị đối xử không phải"
...
V["реплика"] = "lời đối đáp, câu thoại (một lượt nói của nhân vật)"
...
V["охота"] = "việc đi săn; (мне ~) sự thèm làm gì đó"
...
V["диалог"] = "cuộc đối thoại (lời qua tiếng lại giữa hai bên)"
...
V["другой"] = "khác, cái kia (một cái khác thay cho cái này)"
