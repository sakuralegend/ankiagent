...
V = {
    "первый":       "thứ nhất, đầu tiên (số thứ tự 1)",
    "второй":       "thứ 2, thứ nhì (số thứ tự, không phải ngày trong tuần)",
    "третий":       "thứ 3 (số thứ tự, không phải ngày trong tuần)",
    "четвёртый":    "thứ 4 (số thứ tự, không phải ngày trong tuần)",
    "пятый":        "thứ 5 (số thứ tự, không phải ngày trong tuần)",
    "шестой":       "thứ 6 (số thứ tự, không phải ngày trong tuần)",
    "седьмой":      "thứ 7 (số thứ tự, không phải ngày trong tuần)",
    "сотый":        "thứ 100",
    "тысячный":     "thứ 1000; hàng nghìn, đông tới nghìn",
    "двухтысячный": "thứ 2000; (thuộc) năm 2000",
}
