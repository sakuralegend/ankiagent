...
| Chờ Difficulty của thẻ tự hồi phục khi trả lời Good | **HẾT HẠN 04/08** — đo lại ra số khác | Đo 25/07: `w7=0.001` ⇒ **610 lần** Good mới về 50%, **0/84 thẻ** hồi phục. Optimize 04/08 kéo `w7` lên **0.0486** (~14 lần Good), thẻ hoá thạch **402 → 0**, và **77%** trong 675 thẻ từng quên ≥3 lần đang có chuỗi ≥3 lượt đúng. KHÔNG cần Forget/Reset nữa. Nguyên nhân w7 lên: nhóm thẻ quên ≥6 lần nhớ được **60,6% → 73,5%** sau khi user thôi cày Again ⇒ **lật lại được** nếu nếp bấm nút xấu quay lại. Số đo: `data/fsrs_moc.json` |
